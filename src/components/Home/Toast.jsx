...
const Toast = ({ user, hour }) => {
    ...
    return (
        <div className="w-full shadow p-4 max-w-[90%] z-50 text-gray-500 bg-white rounded-lg mt-2">
            <div className="flex" onClick={() => handleClick(user.messages[0]?.status)}>
