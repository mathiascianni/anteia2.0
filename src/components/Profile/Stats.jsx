        ...
        <>
            <div>
                <ul>
                    ...
                    <li className="flex items-center gap-1"><Badge width={iconSize} height={iconSize} path={"fill-primary"} />Cantidad de insignias: <span className='text-primary font-bold'>{user.badges.length}</span></li>
                </ul>
            </div>
        </>
    )
