    ...
    return (
        <div className="relative w-full min-w-[200px] h-10">
            <input
                ...
                value={value}
                onChange={onChange}
                className="peer w-full h-full border-t-transparent border-l-transparent border-r-transparent bg-transparent text-blue-gray-700 font-sans font-normal outline outline-0 focus:outline-0 border-b-gray-300 border focus:border-2  text-sm px-3 py-2.5  focus:border-b-blue-700"
                placeholder=" " />
            <label
