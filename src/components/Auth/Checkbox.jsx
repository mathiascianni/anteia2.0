...
const Checkbox = ({text}) => {
    return (
        <div class="flex items-center px-4 mt-4">
                <label class="relative flex items-center px-1 py-4 rounded-full cursor-pointer" htmlFor="customStyle">
                    <input type="checkbox"
                ...
                <label for="customStyle" className="mx-1 text-sm">{text}</label>
            </div>
    );
}
